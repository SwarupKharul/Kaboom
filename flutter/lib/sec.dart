    ...
    return Scaffold(
      ...
      body: new Stack(
        children: <Widget> [
          ...
          new Container(
            margin: EdgeInsets.only(top: 610, left: 20.0, right: 20.0, bottom: 20.0),
            child: new Material(
              elevation: 5.0,
           ...
           child: Column(
             children: <Widget>[
               Padding(
                 ...
                 child: Text("Comics", style: TextStyle(fontSize: 20.0, color: Color(0xFFFBCD2F)),
                 ),
               ),
               SizedBox(
         ...
         Container(
           ...
           child: Column(
             children: <Widget>[
               Padding(
                 padding: const EdgeInsets.all(4.0),
                 child: Text("NFT's", style: TextStyle(fontSize: 20.0, color: Color(0xFFFBCD2F)),
                 ),
               ),
               SizedBox(
                height: 150, // card height
